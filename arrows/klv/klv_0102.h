...
enum klv_0102_tag : klv_lds_key
{
  ...
  KLV_0102_UMID_VIDEO                                = 15,
  KLV_0102_UMID_AUDIO                                = 16,
  KLV_0102_UMID_DATA                                 = 17,
  KLV_0102_UMID_SYSTEM                               = 18,
  KLV_0102_STREAM_ID                                 = 19,
  KLV_0102_TRANSPORT_STREAM_ID                       = 20,
  KLV_0102_ITEM_DESIGNATOR_ID                        = 21,
  KLV_0102_VERSION                                   = 22,
  KLV_0102_COUNTRY_CODING_METHOD_VERSION_DATE        = 23,
  KLV_0102_OBJECT_COUNTRY_CODING_METHOD_VERSION_DATE = 24,
  KLV_0102_ENUM_END,
};
