...
auto const expected_result = klv_universal_set{
  ...
  { to_key( KLV_0104_FRAME_CENTER_ELEVATION ),  kld{  3216.03723f } },
  { to_key( KLV_0104_IMAGE_COORDINATE_SYSTEM ), std::string{ "UTM" } },
  { to_key( KLV_0104_TARGET_WIDTH ),            kld{  722.819867f } },
  ...
  { to_key( KLV_0104_CORNER_LATITUDE_POINT_1 ),  kld{ -10.5796380 } },
  { to_key( KLV_0104_CORNER_LATITUDE_POINT_2 ),  kld{ -10.5661816 } },
  { to_key( KLV_0104_CORNER_LATITUDE_POINT_3 ),  kld{ -10.5527275 } },
  { to_key( KLV_0104_CORNER_LATITUDE_POINT_4 ),  kld{ -10.5392712 } },
  { to_key( KLV_0104_CORNER_LONGITUDE_POINT_1 ), kld{  29.1273678 } },
  { to_key( KLV_0104_CORNER_LONGITUDE_POINT_2 ), kld{  29.1408242 } },
  { to_key( KLV_0104_CORNER_LONGITUDE_POINT_3 ), kld{  29.1542783 } },
  { to_key( KLV_0104_CORNER_LONGITUDE_POINT_4 ), kld{  29.1677346 } },
  { to_key( KLV_0104_SLANT_RANGE ),              kld{  68590.9832f } },
  { to_key( KLV_0104_SENSOR_ROLL_ANGLE ),        kld{  176.865437f } },
  { to_key( KLV_0104_ANGLE_TO_NORTH ),           kld{  160.719211f } },
  { to_key( KLV_0104_OBLIQUITY_ANGLE ),          kld{  348.792324f } },
  { to_key( KLV_0104_PLATFORM_ROLL_ANGLE ),      kld{  3.40586566f } },
  { to_key( KLV_0104_PLATFORM_PITCH_ANGLE ),     kld{ -0.431531724f } },
  { to_key( KLV_0104_PLATFORM_HEADING_ANGLE ),   kld{  159.974365f } },
  { to_key( KLV_0104_HORIZONTAL_FOV ),           kld{  144.571298f } },
  { to_key( KLV_0104_VERTICAL_FOV ),             kld{  152.643626f } },
  { to_key( KLV_0104_DEVICE_ALTITUDE ),          kld{  14190.7195f } },
